...
impl SwigForeignCLikeEnum for CommandType {
    fn as_jint(&self) -> jint {
        match *self {
            MyEnum::CreateView => 0i32,
            MyEnum::SetChild => 1i32,
        }
    }
    fn from_jint(x: jint) -> Self {
        match x {
            0i32 => MyEnum::CreateView,
            1i32 => MyEnum::SetChild,
            _ => panic!(concat!("{} not expected for ", stringify!(CommandType)), x),
        }
    }
}
#[allow(dead_code)]
impl SwigFrom<CommandType> for jobject {
    fn swig_from(x: CommandType, env: *mut JNIEnv) -> jobject {
        let cls: jclass =
            swig_jni_find_class!(FOREIGN_ENUM_COMMANDTYPE, "com/onee/rusty/CommandType");
        assert!(!cls.is_null());
        let static_field_id: jfieldID = match x {
            MyEnum::CreateView => {
                let field = swig_jni_get_static_field_id!(
                    FOREIGN_ENUM_COMMANDTYPE_CREATEVIEW,
                    FOREIGN_ENUM_COMMANDTYPE,
                    "CreateView",
                    "Lcom/onee/rusty/CommandType;"
                );
            ...
            MyEnum::SetChild => {
                let field = swig_jni_get_static_field_id!(
                    FOREIGN_ENUM_COMMANDTYPE_SETCHILD,
                    FOREIGN_ENUM_COMMANDTYPE,
                    "SetChild",
                    "Lcom/onee/rusty/CommandType;"
                );
        ...
        assert!(
            !ret.is_null(),
            concat!("Can get value of item in ", "com/onee/rusty/CommandType")
        );
        ret
    }
}
impl SwigForeignClass for CommandList {
    ...
    fn jni_class() -> jclass {
        swig_jni_find_class!(FOREIGN_CLASS_COMMANDLIST, "com/onee/rusty/CommandList")
    }
    fn jni_class_pointer_field() -> jfieldID {
...
#[allow(unused_variables, unused_mut, non_snake_case, unused_unsafe)]
#[no_mangle]
pub extern "C" fn Java_com_onee_rusty_CommandList_init(env: *mut JNIEnv, _: jclass) -> jlong {
    let this: CommandList = { Vec::new() };
    let this: Box<CommandList> = Box::new(this);
    let this: *mut CommandList = Box::into_raw(this);
    this as jlong
}
...
#[no_mangle]
pub extern "C" fn Java_com_onee_rusty_CommandList_do_1len(
    env: *mut JNIEnv,
    _: jclass,
    this: jlong,
) -> jlong {
    let this: &CommandList = unsafe { jlong_to_pointer::<CommandList>(this).as_mut().unwrap() };
    let mut ret: usize = CommandList::len(this);
    let mut ret: jlong = <jlong>::swig_from(ret, env);
    ret
}
#[allow(non_snake_case, unused_variables, unused_mut, unused_unsafe)]
#[no_mangle]
pub extern "C" fn Java_com_onee_rusty_CommandList_do_1at(
    env: *mut JNIEnv,
    _: jclass,
    this: jlong,
    i: jlong,
) -> jlong {
    let mut i: usize = <usize as ::std::convert::TryFrom<jlong>>::try_from(i)
        .expect("invalid jlong, in jlong => usize conversation");
    let this: &CommandList = unsafe { jlong_to_pointer::<CommandList>(this).as_mut().unwrap() };
    let mut ret: Command = { &this[i] };
    let ret: jlong = <Command>::box_object(ret);
    ret
}
#[allow(non_snake_case, unused_variables, unused_mut, unused_unsafe)]
#[no_mangle]
pub extern "C" fn Java_com_onee_rusty_CommandList_do_1push_1back(
    env: *mut JNIEnv,
    _: jclass,
    this: jlong,
    s: jlong,
) -> () {
    let s: *mut Command = unsafe { jlong_to_pointer::<Command>(s).as_mut().unwrap() };
    let s: Box<Command> = unsafe { Box::from_raw(s) };
    let s: Command = *s;
...
#[allow(unused_variables, unused_mut, non_snake_case, unused_unsafe)]
#[no_mangle]
pub extern "C" fn Java_com_onee_rusty_CommandList_do_1delete(
    env: *mut JNIEnv,
    _: jclass,
    this: jlong,
) {
...
impl SwigForeignClass for Command {
    type PointedType = Command;
    fn jni_class() -> jclass {
        swig_jni_find_class!(FOREIGN_CLASS_COMMAND, "com/onee/rusty/Command")
    }
    fn jni_class_pointer_field() -> jfieldID {
        swig_jni_get_field_id!(
            FOREIGN_CLASS_COMMAND_MNATIVEOBJ_FIELD,
            FOREIGN_CLASS_COMMAND,
            "mNativeObj",
            "J"
        )
    }
    fn box_object(this: Self) -> jlong {
        let this: Box<Command> = Box::new(this);
        let this: *mut Command = Box::into_raw(this);
        this as jlong
    }
    fn unbox_object(x: jlong) -> Self {
        let x: *mut Command = unsafe { jlong_to_pointer::<Command>(x).as_mut().unwrap() };
        let x: Box<Command> = unsafe { Box::from_raw(x) };
        let x: Command = *x;
        x
    }
    fn to_pointer(x: jlong) -> ::std::ptr::NonNull<Self::PointedType> {
...
#[allow(unused_variables, unused_mut, non_snake_case, unused_unsafe)]
#[no_mangle]
pub extern "C" fn Java_com_onee_rusty_Command_init(env: *mut JNIEnv, _: jclass) -> jlong {
    let this: Command = {
        Command {
...
#[allow(non_snake_case, unused_variables, unused_mut, unused_unsafe)]
#[no_mangle]
pub extern "C" fn Java_com_onee_rusty_Command_do_1get_1commandType(
    env: *mut JNIEnv,
    _: jclass,
    this: jlong,
) -> jint {
    let this: &Command = unsafe { jlong_to_pointer::<Command>(this).as_mut().unwrap() };
    let mut ret: CommandType = { this.commandType };
    let mut ret: jint = ret.as_jint();
    ret
}
#[allow(unused_variables, unused_mut, non_snake_case, unused_unsafe)]
#[no_mangle]
pub extern "C" fn Java_com_onee_rusty_Command_do_1delete(env: *mut JNIEnv, _: jclass, this: jlong) {
    let this: *mut Command = unsafe { jlong_to_pointer::<Command>(this).as_mut().unwrap() };
    let this: Box<Command> = unsafe { Box::from_raw(this) };
    drop(this);
}
static mut FOREIGN_CLASS_COMMAND: jclass = ::std::ptr::null_mut();
static mut FOREIGN_CLASS_COMMAND_MNATIVEOBJ_FIELD: jfieldID = ::std::ptr::null_mut();
...
static mut FOREIGN_ENUM_COMMANDTYPE: jclass = ::std::ptr::null_mut();
static mut FOREIGN_ENUM_COMMANDTYPE_CREATEVIEW: jfieldID = ::std::ptr::null_mut();
static mut FOREIGN_ENUM_COMMANDTYPE_SETCHILD: jfieldID = ::std::ptr::null_mut();
...
pub extern "system" fn JNI_OnLoad(
    ...
    unsafe {
        let class_local_ref =
            (**env).FindClass.unwrap()(env, swig_c_str!("com/onee/rusty/Command"));
        assert!(
            !class_local_ref.is_null(),
            concat!("FindClass failed for ", "com/onee/rusty/Command")
        );
        ...
        FOREIGN_CLASS_COMMAND_MNATIVEOBJ_FIELD = field_id;
    }
    unsafe {
    ...
    unsafe {
        let class_local_ref =
            (**env).FindClass.unwrap()(env, swig_c_str!("com/onee/rusty/CommandType"));
        assert!(
            !class_local_ref.is_null(),
            concat!("FindClass failed for ", "com/onee/rusty/CommandType")
        );
        let class = (**env).NewGlobalRef.unwrap()(env, class_local_ref);
        assert!(
            !class.is_null(),
        ...
        (**env).DeleteLocalRef.unwrap()(env, class_local_ref);
        FOREIGN_ENUM_COMMANDTYPE = class;
        let field_id: jfieldID = (**env).GetStaticFieldID.unwrap()(
            env,
            class,
            swig_c_str!("CreateView"),
            swig_c_str!("Lcom/onee/rusty/CommandType;"),
        );
        assert!(
            !field_id.is_null(),
            concat!(
                "GetStaticFieldID for class ",
                "com/onee/rusty/CommandType",
                " method ",
                "CreateView",
                " sig ",
                "Lcom/onee/rusty/CommandType;",
        ...
        FOREIGN_ENUM_COMMANDTYPE_CREATEVIEW = field_id;
        let field_id: jfieldID = (**env).GetStaticFieldID.unwrap()(
            env,
            class,
            swig_c_str!("SetChild"),
        ...
        FOREIGN_ENUM_COMMANDTYPE_SETCHILD = field_id;
    }
    unsafe {
    ...
    unsafe {
        let class_local_ref =
            (**env).FindClass.unwrap()(env, swig_c_str!("com/onee/rusty/CommandList"));
        assert!(
            !class_local_ref.is_null(),
            concat!("FindClass failed for ", "com/onee/rusty/CommandList")
        );
        let class = (**env).NewGlobalRef.unwrap()(env, class_local_ref);
        assert!(
            !class.is_null(),
...
pub extern "system" fn JNI_OnUnload(java_vm: *mut JavaVM, _reserved: *mut ::std::os::raw::c_void) {
    ...
    assert!(!env.is_null());
    unsafe {
        (**env).DeleteGlobalRef.unwrap()(env, FOREIGN_CLASS_COMMAND);
        FOREIGN_CLASS_COMMAND = ::std::ptr::null_mut()
    }
    unsafe {
    ...
    unsafe {
        (**env).DeleteGlobalRef.unwrap()(env, FOREIGN_ENUM_COMMANDTYPE);
        FOREIGN_ENUM_COMMANDTYPE = ::std::ptr::null_mut()
    }
    unsafe {
